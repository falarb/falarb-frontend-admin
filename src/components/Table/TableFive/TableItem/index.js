...
export default function TableItem({
  ...
  return (
    <div className={`table-item ${height}`}>
      {
        id ? <div className="table-item-id"><a target="_blank" href={`https://wa.me/55${limparNumero(id)}`}><svg xmlns="http://www.w3.org/2000/svg" className="bi bi-whatsapp" viewBox="0 0 16 16">
